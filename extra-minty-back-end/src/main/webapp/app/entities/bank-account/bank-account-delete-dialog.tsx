...
export const BankAccountDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="extraMintyApp.bankAccount.delete.question">
        <Translate contentKey="extraMintyApp.bankAccount.delete.question" interpolate={{ id: bankAccountEntity.id }}>
